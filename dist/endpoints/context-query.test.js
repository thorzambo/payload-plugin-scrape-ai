...
describe('tokenize', ()=>{
    ...
    it('filters single-char tokens', ()=>{
        expect(tokenize('a big cat')).toEqual([
            'big',
            'cat'
        ]);
    });
    ...
    it('handles mixed case', ()=>{
        expect(tokenize('TypeScript Testing')).toEqual([
            'typescript',
            'testing'
        ]);
    });
    it('preserves multi-char tokens only', ()=>{
        expect(tokenize('I am a developer')).toEqual([
            'am',
            'developer'
        ]);
    });
...
//# sourceMappingURL=context-query.test.js.map